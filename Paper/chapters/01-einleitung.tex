...
\label{ch:einleitung}
\section{Motivation}
\label{sec:motivation} %TODO: Höhere Metaebene --> Was hat das für Auswirkungen wenn Jobs verloren gehen oder das system ausfällt --> z.B. Wenn Analysen dadurch ausbleiben kann es richtig teuer werden
...
\label{sec:problemstellung} %TODO: Thunerdering Herds Problem aufgreifen
...
auf die Zuverlässigkeit des Gesamtsystems für Entwickler nur eingeschränkt nachvollziehbar sind. %TODO: --> hier fällt das mit den Datenbanken einfach vom Himmel --> sehr nischig, vorher unbedingt mehr motivieren
