...
Dieses Kapitel beantwortet in diesem Bezug die Forschungsfragen und führt zusätzlich gewonnene Erkenntnisse auf.
...
Für \ref{item:tf1} wurden in \cref{sec:zusicherungen} in Abhängigkeit zum betrachteten Fehlermodell konkrete Zusicherungen abgeleitet.
Die Evaluation zeigt, dass durch die Umsetzung dieser Zusicherungen die Teilausfälle des betrachteten Fehlermodells behandelt werden können.
...
Operationen ohne Auftreten von Inkonsistenzen synchronisiert werden, obwohl kurze Transaktionen verwendet werden.
...
Insbesondere entfällt dadurch architekturieller Aufwand zur Konsistenzerhaltung zwischen Datenbank und Broker.
