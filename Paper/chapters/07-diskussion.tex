...
\textbf{Begrenzte Aussagekraft der Evaluation.}
Sämtliche Testfälle laufen gegen einen kontrollierten Ausgangszustand und lassen sich
beliebig oft wiederholen, ohne dass eine manuelle Anpassung erforderlich ist.
Besondere Relevanz für die Aussagekraft der Evaluation besitzt dabei die wiederholte Ausführung der Testfälle zu
\ref{zus:exklusive_rechte} und \ref{zus:endzustaende}.
...
Die Wiederholung über 100 Durchläufe bestätigt, dass die Kriterien unabhängig von der konkreten Schedule eingehalten
werden, statt nur einmalig zufällig zuzutreffen.
Zusätzlich wurde nachgewiesen, dass tatsächlich unterschiedliche Schedules auftraten,
sodass nur unter selteneren Ausführungsreihenfolgen sichtbare Fehler mit hoher Wahrscheinlichkeit erkannt worden wären.

Gleichwohl bleibt die Evaluation an eine kontrollierte Testumgebung und eine endliche Anzahl von Testwiederholungen gebunden.
Insbesondere für die nebenläufigkeitsabhängige Szenarien kann daher nicht ausgeschlossen werden, dass unter anderen Ausführungsbedingungen
...
Die Arbeit untersucht die Funktionsfähigkeit der Fehlertoleranzmechanismen des entwickelten Systems, nicht dessen Verhalten unter hoher Last.
