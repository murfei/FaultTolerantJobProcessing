...
\section{Quellcode}
\label{sec:quellcode}
Der im Rahmen dieser Arbeit entwickelte Quellcode einschließlich der implementierten Tests sowie der vollständigen,
der Evaluation zugrunde liegenden Testausführungsprotokolle ist im folgenden GitHub-Repository im Verzeichnis \texttt{src} verfügbar:

\url{https://github.com/murfei/FaultTolerantJobProcessing}
