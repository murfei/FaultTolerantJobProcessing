...
\begin{table}[htbp]
    ...
    \end{tabularx}
    \caption[Zuordnung von Zusicherungen zu den jeweiligen Testmethoden]{Zuordnung der definierten Systemzusicherungen zu den Testmethoden, mit denen
    ihre Einhaltung im Rahmen der Evaluation überprüft wird.}
