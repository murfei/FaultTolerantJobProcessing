...
Wie bereits in \cref{sec:problemstellung} motiviert, wird im Rahmen dieser Arbeit hingegen untersucht, ob sich die benötigten
...
die mehreren Workern eine effiziente, gegenseitig nicht blockierende Datenauswahl ermöglicht.
...
Demgegenüber garantiert PostgreSQL die Dauerhaftigkeit eines Datensatzes, der in einer durch ein erfolgreichen Commit
...
Die Datenbank übernimmt im System nicht ausschließlich die Rolle eines persistenten Datenspeichers, sondern fungiert gleichzeitig
als Warteschlange sowie als Synchronisationsmechanismus zwischen konkurrierenden Workern.
Funktional orientiert sich die Architektur damit an den Prinzipien eines klassischen Message Brokers, nutzt jedoch die
Konsistenzgarantien einer relationalen Datenbank als Grundlage für die Umsetzung der definierten Zusicherungen.
...
Ansatz damit eine geeignete und praktikable Architektur dar, da auf eine aufwändige Clusterstruktur zur Absicherung von
