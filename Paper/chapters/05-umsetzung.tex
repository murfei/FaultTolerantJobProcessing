%! Author = murfe
%! Date = 06.09.2026
%TODO: Schreibweise von Methodennamen in ganzer Arbeit nochmal prüfen: entweder einheitlich \texttt oder \textit
\chapter{Umsetzung}
\label{ch:umsetzung}
...
Während der gesamten Bearbeitungsdauer würden dadurch Datenbankverbindungen sowie Sperren unnötig lange gehalten werden müssen. %TODO: hier sehr kurze unzusammenhängende Sätze
...
Da der Prototyp nur eine simulierte Fachlogik mit festgelegter Jobdauer nutzt, werden im Rahmen dieser Arbeit lediglich zeitbasierte Leases genutzt.
...
Als Job-Store wird PostgreSQL eingesetzt. %TODO: Wird (zum Teil) schon im Architekturteil begründet
