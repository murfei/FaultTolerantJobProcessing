...
\Cref{subsec:idempotenteErgebnisgenerierung} schließt den Entwurf ab, indem die Nutzung des \textit{Fencing}-Prinzip zur Vermeidung
...
\textit{claimed\_by}, \textit{attempt\_count} oder \textit{lease\_until} werden aktualisiert.
...
Transaktion der Status auf \textit{Queued} sowie die Attribute \textit{claimed\_by} und \textit{lease\_until} zurückgesetzt.
