...
Dadurch kann wie in \cref{subsec:test_und_nachweismethoden} beschrieben das Zusammenspiel von \gls{rest}-Schnittstelle,
Service-Schicht, Retry- und Recovery-Mechanismen sowie der Datenbank getestet werden.
...
Das Ziel dabei war die einzelnen Komponenten so aufeinander abzustimmen, dass die betrachteten Fehlerinjektionen reproduzierbar
durchgeführt werden können und die vorgesehenen Konkurrenzsituationen gezielt erzeugt werden können.
