...
Die Wahl von 100 Wiederholungen stellt dabei einen Kompromiss zwischen der Testabdeckung unwahrscheinlicher Grenzfälle %TODO: 100 hier glaube ich schon in Methodik erwähnt
...
Daraufhin wird geprüft, ob der Worker Prozess den Job tatsächlich nicht beenden konnte.
Anschließend wird ein zweiter, unabhängiger Prozess mit laufendem Worker gestartet.
...
\ref{item:h2} wird durch die vorliegenden Ergebnisse bestätigt.
